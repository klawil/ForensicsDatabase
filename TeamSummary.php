...
echo "<div id='visualization' style='width: 99%'></div>
<script>
function MakeGraph() {
...
$query = mysql_query("select TName from Results, Tournaments where Results.TID = Tournaments.TID group by Date order by Date;");
if (( mysql_errno() )) {
	echo "Error - MySQL error " . mysql_errno() . ": " . mysql_error() . ".";
} else {
