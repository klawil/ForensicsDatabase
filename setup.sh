...
$mysqlc -D $mysqldbname -e "create table users ( UName varchar(20) not null, FName varchar(30) not null, LName varchar(30) not null, password varchar(255) not null, Email varchar(255), cookie varchar(255), cookieExp varchar(255), primary key (UName) );"
if [ "$?" != "0" ]; then
